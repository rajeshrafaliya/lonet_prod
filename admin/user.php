<?php
    ...
    $acl          = 0;//optional_param('acl', '0', PARAM_INT);           // id of user to tweak mnet ACL (requires $access)
    ...
    $columns = array_merge($allusernamefields, $extracolumns, array('city', 'country','firstnamephonetic','lastaccess'));
