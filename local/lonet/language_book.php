...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	$PAGE->set_url('/local/lonet/language_book.php');
	...
	<?php
// 	print_r($booking['order_products']);
// 	die();
    if ($booking['order_products']) {
		...
		<div class="row">
			<div class="col-sm-8 user-row">
				...
				<?php if ($lang_camp) { ?>
                    <h2>Booking for language classes with tutors on Lonet.Academy</h2>
                            ...
                            <div class="col-xs-9 col-sm-10">
                                <div class="row">
                                    ...
                                    <div class="col-xs-8 col-sm-3">
                                        <b>€</b>&nbsp;<?= $camp->amount ?>&nbsp;&times;&nbsp;<?= $camp->count ?>
                                    </div>
                                    <div class="col-xs-4 col-sm-2">
                                        <b>€</b>&nbsp;<?= $camp->price ?>
                                    </div>
			...
			<div class="col-sm-4 col-options">
				<div class="col-sm-12 user-row">
                    ...
                    if ($order_amount > 0) {
                        ...
                        ?>
                        <?php $isCampBooking = count($lang_camp) > 0 ? 1 : 0; ?>
                        
						<p><a class="btn btn-block btn-success btn-payment" href="/local/lonet/payment.php?method=card&isCampBooking=<?= $isCampBooking ?>" data-type="card"><?= get_string('paywithcard', 'local_lonet') ?></a></p>
						<p>
                            <a class="btn btn-block btn-success btn-payment" href="/local/lonet/payment.php?method=paypal&isCampBooking=<?= $isCampBooking ?>" data-type="paypal"><?= get_string('paywith', 'local_lonet') ?> <img src="/theme/lonet/pix/payment/paypal.png"> *</a>
