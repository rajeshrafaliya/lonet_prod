...
<a href="https://twitter.com/lonet_academy" target="_blank" style="vertical-align:middle;"><img src="'.$CFG->wwwroot.'/theme/lonet/pix/icons/x.png" alt="twitter" /></a>
...
$string['platformforlangapply'] = 'Apply';
...
$string['teachersaboutus'] = 'What teachers say about us';
...
$string['commissionperpackage'] = 'Commission Per Package';
$string['commissionperpackage_desc'] = 'This amount will be added to teacher\'s package price.';
$string['card_fee_message'] = '+3% is processing fee';
$string['becometutor_faq1_question'] = 'Do you accept non-native tutors?';
$string['becometutor_faq1_answer'] = 'Yes, we do. We value diversity, equality, and inclusion.  Both, native and non-native qualified language tutors are welcome to join Lonet.';
$string['becometutor_faq2_question'] = 'Do I have to have previous teaching experience?';
$string['becometutor_faq2_answer'] = 'Yes, we strive to connect our learners with experienced tutors. We accept ONLY experienced educators with at least 100 hours of lessons/sessions conducted.';
$string['becometutor_faq3_question'] = 'How are you different from other platforms?';
$string['becometutor_faq3_answer'] = 'We are the most educators-friendly platform. We provide three distinct types of educators for our learners to choose from. We secure a low level of competition between educators. We strive for teachers\' well-being and professional growth.';
$string['becometutor_faq4_question'] = 'Can I create my profile without a presentation video?';
$string['becometutor_faq4_answer'] = 'No. The video is mandatory. Your presentation video is one of the most important ways for learners to meet you, hear your voice, and see you smiling before they decide to book a trial session with you.';
$string['becometutor_faq5_question'] = 'Do you provide a syllabus and teaching materials?';
$string['becometutor_faq5_answer'] = 'No, we don\'t provide them. But we can give you recommendations on the latest trends, you can contact your fellows-tutors to exchange materials and ideas. Otherwise, you are independent in choosing your materials and teaching strategies according to every learner\'s individual needs.';
$string['becometutor_faq_loadmore'] = 'Load More';
$string['teacher_breadcrumb_all_teachers']='all teachers';