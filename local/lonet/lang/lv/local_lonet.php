...
$string['platformforlang'] = 'Labākā platforma valodu pasniedzējiem, trenneriem un koučiem';
$string['platformforlangdesc'] = 'Pasniedz valodu sev ērtā laikā un vietā, nemaksājot komisiju.';
$string['platformforlangapply'] = 'Piesakies';
$string['benifitofpart'] = 'Lonet platformas priekšrocības';
$string['maximizeearn'] = 'Pelni vairāk';
$string['maximizeearndesc'] = 'Mūsu pasniedzēji nemaksā komisijas maksu. Cena ko norādi, ir tā ko saņem - skaidri un gaiši.';
$string['focuson'] = 'Dari to, kas patīk';
$string['focusondesc'] = 'Ja mācīšana ir Tava sirdslieta, tad fokusējies uz to. Atstāj studentu piesaisti un mārketingu mums.';
$string['buildbrand'] = 'Audzē savu profesionālo brendu';
$string['buildbranddesc'] = 'Izveido stabilu studentu bāzi Lonet platformā, iegūstot pieredzi un atsauksmes.';
$string['growprof'] = 'Gūsti pieredzi';
$string['growprofdesc'] = 'Iepazīsti motivētus skolēnus un citus pasniedzējus no visas pasaules. Bagātini savu pieredzi mainoties ar kontaktiem, idejām un ieskatiem.';
$string['enjoypay'] = 'Baudi neatkarību';
$string['enjoypaydesc'] = 'Nosaki savu darba grafiku, stundas likmi un darba apjomu. Strādā no jebkuras vietas pasaulē. Baudi pilnīgu neatkarību!';
$string['growwithus'] = 'Jūties droši un ērti';
$string['growwithusdesc'] = 'Lielās mācību platformās pasniedzēji konkurē savā starpā. Mēs, savukārt, fokusējamies uz pasniedzēju labklājību, nodrošinot cieņu un patīkamu vidi.';
$string['joinlonet'] = 'Pievienojies mums ja esi';
$string['langcoach'] = 'Valodu koučs';
$string['ifyou'] = '';
$string['arecoach'] = 'Ar kouča sertifikātu';
$string['holdquali'] = 'Ar kouča kvalifikāciju';
$string['positivepsyco'] = 'Ar pozitīvu attieksmi';
$string['langtutor'] = 'Valodu pasniedzējs/-a';
$string['holdteaching'] = 'Ar pasniedzēja/-as sertifikātu';
$string['areteacher'] = 'Ar profesionālu izglītību';
$string['holddegree'] = 'Ar citu atbilstošu izglītību';
$string['langtrainer'] = 'Valodu trenneris/-e';
$string['arespeaker'] = 'Kas runā dzimtajā valodā';
$string['havetutexp'] = 'Ar online apmācību pieredzi';
$string['passionaboutlang'] = 'Kam valodas ir sirdslieta';
$string['wanttoapply'] = 'Vēlos pievienoties!';
$string['lonetforedu'] = 'Pieteikšanas process';
$string['lonetforedudesc'] = '';
$string['applyanedu'] = 'Piesakies kā pasniedzējs/-a';
$string['completeappli'] = 'Izveido pieteikumu';
$string['setprofile'] = 'Publicē savu profilu';
$string['chooserole'] = 'Izvēlies savu lomu:';
$string['freeaccount'] = '';
$string['langtutormsg'] = 'ja esi kvalificēts/-a valodas privātskolotājs/-a (ar profesionālu izglītību vai tādu mācību sertifikātu kā CELTA vai TEFL) - piesakies kā pasniedzējs/-a.';
$string['langcoachmsg'] = 'ja Tev ir koučinga sertifikāts, psihologa diploms vai esi izgājis/-usi pozitīvās psiholoģijas kursu - piesakies kā valodu koučs.';
$string['langtrainermsg'] = ' ja pasniedz savu dzimto valodu un Tev ir valodu online apmācības pieredze, tad piesakies kā valodu trenneris/-e.';
$string['setrates'] = 'Nosaki savu likmi:';
$string['setratesdesc'] = 'pārvaldi savu cenu politiku bez lielo platformu intensīvās cenu sāncensības.';
$string['setavail'] = 'Izbrīvē savu laiku:';
$string['setavaildesc'] = 'izvēlies kad un cik ilgi vēlies strādāt, pārvaldot savu pieejamību. Mums nav minimālo stundu kas būtu jāstrādā.';
$string['managecal'] = 'Pārvaldi savu kalendāru:';
$string['managecaldesc'] = 'bloķē vai atbrīvo pieejamo laiku savā kalendārā atkarībā no mainīgajām dzīves situācijām.';
$string['youallset'] = '🎉 Tas arī viss!';
$string['showcaseexp'] = 'Pastāsti par sevi:';
$string['showcaseexpdesc'] = '';
$string['scheduleinter'] = ' Izvēlies intervijas laiku';
$string['scheduleinterdesc'] = 'pēc profila aizpildīšanas, saņemsi e-pastu ar aicinājumu uz interviju ar Lonet.Academy dibinātāju - Kristīni. Sarunas laikā droši uzdod sev interesējošus jautājumus par platformu un tās darbību.';
$string['education'] = 'Izglītība:';
$string['educationdesc'] = 'kāda Tev ir izglītība - diplomi, atestāti, grādi vai sertifikāti?';
$string['experience'] = 'Pieredze:';
$string['experiencedesc'] = 'kāda ir Tava pasniegšanas pieredze? Specializācijas un iemaņas?';
$string['yourapproch'] = 'Tava pieeja:';
$string['yourapprochdesc'] = 'Tava pieeja: Kā Tu māci - Tavas metodes, tehnika un ieskati.';
/* No translation*/
...
$string['teachersaboutus'] = 'Pasniedzēju atsauksmes par mums';
...
/** */
$string['thrivcommunity'] = 'Pievienojies mūsu valodu izglītotāju kopienai';
$string['thrivcommunitydesc'] = 'Lonet komanda palīdz izglītotājiem fokusēties uz savu darbu un labsajūtu, veidojot pozitīvu kopienu, kur viens otru atbalstam attīstībā, augšanā un savstarpējos panākumos.';
$string['growbrand'] = 'Būvē savu brendu';
$string['growbranddesc'] = 'Attīsti savu pasniedzēja brendu ar personīgo profilu, studentu atsauksmēm un sirsnīgu izglītotāju kopienu.';
$string['maximizeearn2desc'] = 'Mūsu pasniedzēji nemaksā komisijas maksu, paturot visus ienākumus sev.';
$string['focuson2desc'] = 'Lonet komanda parūpēsies par mārketingu lai Tu vari fokusēties uz savu sirdslietu - pasniegšanu!';
$string['ready2join'] = 'Pievienojies!';
$string['ready2joindesc'] = 'Pievienojies mūsu valodu pasniedzēju kopienai!';
$string['applynow'] = 'Piesakies';
$string['customersay'] = 'Our customers say'; /** */
$string['excellent'] = 'Excellent'; /** */
$string['outof'] = 'out of'; /** */
$string['faq'] = 'Biežāk uzdotie jautājumi';
/** */
...
$string['becometutor_faq1_question'] = 'Vai pieņemat pasniedzējus, kas māca valodu, kura viņiem nav dzimtā? ';
$string['becometutor_faq1_answer'] = 'Jā, pieņemam. Mūsu pamatvērtības ir daudzveidība, vienlīdzība un iekļaušana. Tāpēc esam atvērti kvalificētiem pasniedzējiem gan dzimtajās, gan svešvalodās.';
$string['becometutor_faq2_question'] = 'Vai man ir nepieciešama iepriekšēja pasniegšanas pieredze?';
$string['becometutor_faq2_answer'] = 'Jā, mūsu mērķis ir piedāvāt studentiem pieredzējušus pasniedzējus. Tāpēc pieņemam TIKAI valodu pasniedzējus kam ir minimums 100 stundu pasniegšanas pieredze.';
$string['becometutor_faq3_question'] = 'Ar ko Lonet atšķiras no citām platformām?';
$string['becometutor_faq3_answer'] = 'Mēs esam pasniedzējiem visdraudzīgākā platforma - piedāvājam studentiem trīs veida valodu pasniedzējus. Mūsu personīgā atlases pieeja nodrošina kvalitatīvu apmācību bez sīvas izglītotāju konkurences. Mēs fokusējamies uz pasniedzēju labklājību un profesionālo izaugsmi. 
Lonet no citām platformām tāpat atšķiras ar ātru un individuālu pieeju gan pasniedzējiem, gan studentiem - mūsu komanda palīdzēs jebkurā jautājumā, jebkurā laikā. 
';
$string['becometutor_faq4_question'] = 'Vai varu publicēt profilu bez iepazīšanās video?';
$string['becometutor_faq4_answer'] = 'Nē, pasniedzēju video ir obligāts. Papildu aprakstam, iepazīšanās video ir galvenais veids kā studenti var Tevi iepazīt, dzirdēt Tavu balsi un saprast vai vēlas rezervēt izmēģinājuma sesiju.';
$string['becometutor_faq5_question'] = 'Vai piedāvājat gatavus mācību materiālus? ';
$string['becometutor_faq5_answer'] = 'Nē, tos mēs nepiedāvājam, taču labprāt ieteiksim populārākās mācību materiālu tendences. Tāpat iedrošinam pasniedzējus komunicēt ar kolēģiem, mainoties idejām un materiāliem. 
Mūsu pasniedzēji var brīvi izvēlēties mācību materiālus un stratēģiju - mēs paļaujamies ka izvēlētais būs pielāgots katra studenta individuālajām vajadzībām.';
$string['becometutor_faq_loadmore'] = 'Parādīt vairāk';
$string['teacher_breadcrumb_all_teachers']='visi skolotāji';
