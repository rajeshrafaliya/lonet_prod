...
<style>
	...
	select[name="Schedule[timeto]"],select[name="Schedule[timefrom]"],input[name="Schedule[dateto]"],input[name="Schedule[datefrom]"]{
		border-radius: 8px;
	...
	.blocktimecontainer .row-block .btn:not(.btn-save),.blockdatecontainer .row-block .btn:not(.btn-save),.blockdatetimecontainer .row-block .btn:not(.btn-save){
		background: none;
		outline: none;
		border: none;
		box-shadow:none;
