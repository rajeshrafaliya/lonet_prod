...
<?php if ($edit) { ?>
	<!--p style="padding: 5px 0 0" class="calinfo">
		<button class="btn-blockthis">B</button> - &nbsp;<span><?= get_string('block', 'local_lonet') ?></span>
		&nbsp;<button class="btn-unblockthis">U</button> - &nbsp;<span><?= get_string('unblock', 'local_lonet') ?></span>
		&nbsp;&nbsp;<button class="btn-confirm">C</button> - &nbsp;<span><?= get_string('confirm', 'local_lonet') ?></span>
		&nbsp;<button class="btn-decline">D</button> - &nbsp;<span><?= get_string('decline', 'local_lonet') ?></span>
		&nbsp;<button class="btn-message" style="background: none;border: none;box-shadow: none;"><i class="fa fa-commenting-o pull-right"></i></button> - &nbsp;<span><?= get_string('msgtogroup', 'local_lonet') ?></span>
	</p-->
<div style="display: flex; gap: 30px;align-items: center;justify-content: space-between;padding:32px;">
...
<?php } ?>
<p class="hidden" style="padding: 5px 0;">
	<?= ($week ? '<button style="border:none;background:none;outline:none;box-shadow:none;" data-week="' . ($week - 1) . '"><svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none"><path d="M6 11L1 6L6 1" stroke="#374151" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>/svg></button>' : '&nbsp;') ?>
	<button class="pull-right" style="border:none;background:none;outline:none;box-shadow:none;" data-week="<?= ($week + 1) ?>"><svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none"><path d="M1 1L6 6L1 11" stroke="#374151" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></button>
</p>
