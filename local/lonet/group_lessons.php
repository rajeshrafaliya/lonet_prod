...
<option value="sw" <?php if(isset($language) && $language=='sw'){?> selected="selected"<?php } ?>> Swahili</option>
            ...
            <div class="row">
                <div class="col-xs-6 col-sm-2 no-padding-r">
                    <div class="user-picture-container">
                        <a href="<?= $CFG->wwwroot ?><?= $url ?>" target="_blank" style="margin-bottom: 5px;"><?= $OUTPUT->user_picture($teacherdetail, ['size' => '100', 'link' => false]) ?></a>
                    ...
                    <div class="text-center" style="margin-top: 15px;">
						<h3><a href="<?= $CFG->wwwroot ?><?= $url ?>" target="_blank" style="font-size: 1em; color: #002b46;"><?= fullname($teacherdetail, true) ?></a> <div class="indicator <?= (user::is_online($teacherdetail) ? 'online' : '') ?>"></div></h3>
                ...
                <div class="col-xs-12 col-sm-7">
                    ...
                    <h3 class="d-inline-block" style="vertical-align:middle;"><a href="<?= $CFG->wwwroot ?><?= $url ?>" target="_blank" style="font-size: 1em; color: #002b46;"><?= $teacher->lessonname ?></a></h3>
					<?php
