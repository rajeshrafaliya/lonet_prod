		...
		<script>
			$(document).ready(function() {
				...
				$('#payout-form').submit(function(e) {
					e.preventDefault();					
					swal({
						title: 'Are you sure you want to proceed with the payout request? After submitting this request, an invoice will be generated automatically and sent to your email. No changes will be accepted.',
						text: 'Payout request amount  EUR ' + $('#selected-amount').text(), 
						icon: 'warning',
						buttons: {
							cancel: {
								text: '<?= get_string('no') ?>',
