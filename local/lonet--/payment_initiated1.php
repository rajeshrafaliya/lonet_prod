...
class PaymentInitiated1
{
    ...
    public function callPaymentApi($amount = 0, $orderid = 0, $method = 'card')
    {
        ...
        $params = array(
            ...
            "api_username" => '4211bd13abd21bc1', // API USERNAME FROM GENERAL SETTINGS
...
//die();
        ...
        $resultArray = $this->curlCall("https://igw-demo.every-pay.com/api/v4/payments/oneoff", $params);
    ...
    public function curlCall($url, $data)
    {
        ...
        $username = '4211bd13abd21bc1'; // API USERNAME FROM GENERAL SETTINGS
        $password = '7afbf3bc4e7e01d74873699d5e5feaf6'; // API SECRET FROM GENERAL SETTINGS
