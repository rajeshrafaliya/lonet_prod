...
if (!empty($potentialidps)) {
	$social_auth_html .= '<div class="potentialidps">';
	$social_auth_html .= '<h6 style="color: #FFF;text-align: center;font-size: 20px;font-weight: 500;padding-bottom: 24px;">' . get_string('potentialidps', 'auth') . '</h6>';
	$social_auth_html .= '<div class="potentialidplist">';
	foreach ($potentialidps as $idp) {
		$social_auth_html .= '<div class="col-sm-6 potentialidp">';
...
<div class="cd-popup cd-popup-login" role="alert">
   <div class="cd-popup-container">
      <div class="log">
        <?= $social_auth_html ?>
        <div style="color: #FFF;text-align: center;font-size: 20px;font-weight: 500;padding-bottom: 24px;">OR</div>
         ...
         <form method="post" id="cf_login" class="loginform" action="<?php echo $CFG->httpswwwroot; ?>/login/index.php">
            ...
            <div class="clearfix"></div>
            <label></label>
            <div class="forgotPassword langmenuContainer mt-3">
               <?php
...
<style>
.forgotPassword a{
	color: #FFF;text-align: center;font-size: 16px;font-weight: 500;
}
.cd-popup-container{padding:20px !important;border-radius: 8px;}
</style>