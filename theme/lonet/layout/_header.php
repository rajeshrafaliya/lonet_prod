...
<html <?= $OUTPUT->htmlattributes() ?>>
	<head>
		...
		<link rel="preload" href="<?= $CFG->wwwroot ?>/theme/lonet/font/Helvetica_Normal.ttf">
        <link rel="preload" href="<?= $CFG->wwwroot ?>/theme/lonet/font/Helvetica_Bold.ttf">
        
        <script>window.onerror =  function() { return true; };</script>
		<?= $OUTPUT->standard_head_html() ?>
		<meta name="viewport" content="width=device-width, initial-scale=1.0">
<script src="https://code.jquery.com/jquery-3.3.1.min.js"></script>    
  <link rel="stylesheet" type="text/css" href="<?= $CFG->wwwroot ?>/theme/lonet/style/slick-theme.css"/>
  <link rel="stylesheet" type="text/css" href="<?= $CFG->wwwroot ?>/theme/lonet/style/slick.css"/>
 ...
 <?php if (strpos($_SERVER['HTTP_HOST'], 'lonet.academy') !== false) { ?>
		...
		<style>
			...
			@font-face {
				...
				src: url('<?= $CFG->wwwroot ?>/theme/lonet/font/Helvetica_Normal.ttf');
				font-weight: normal;
				font-style: normal;
			}
            @font-face {
                font-family: 'helvetica_bold';
                src: url('<?= $CFG->wwwroot ?>/theme/lonet/font/Helvetica_Bold.ttf');
                font-weight: normal;
                font-style: normal;
            }            
			@font-face {
                font-family: 'msaleb_regular';
                src: url('<?= $CFG->wwwroot ?>/theme/lonet/font/Marek_salesb_regular.otf');
                font-weight: normal;
                font-style: normal;
            }
			@font-face {
