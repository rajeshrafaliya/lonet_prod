...
$THEME->javascripts = array(/*'jquery-3.2.1.min',*/'jquery-1.11.3.min', 'jquery.fancybox.pack', 'bootstrap.min', 'sweetalert.min', 'jquery.multi-select', 'ouibounce.min', 'calendar.min', 'awesomplete.min', 'jquery.base64.min','slick.min');