...
$string['happylearners'] = '3+K LAIMĪGI LIETOTĀJI';
$string['besttutorselected'] = 'Uzlabo savu karjeru un dzīvi <br>ar jaunu valodu';
$string['home_choose_language'] = 'Izvēlies valodu';
$string['home_coaches']='Valodu kouči';
$string['home_coaches_desc1']='Palīdzēs uzstādīt un sasniegt mērķus';
$string['home_coaches_desc2']='Izveidos mācību stratēģiju kas strādā tieši Tev';
$string['home_coaches_desc3']='Iemācīs kā pārvarēt bailes un šaubas';
$string['home_coaches_button']='Visi kouči';
$string['home_tutors']='Valodu skolotāji';
$string['home_tutors_desc1']='Uzlabos Tavu gramatiku un vārdu krājumu';
$string['home_tutors_desc2']='Iemācīs valodu pakāpeniski, loģiskā secībā';
$string['home_tutors_desc3']='Palīdzēs sagatavoties eksāmeniem';
$string['home_tutors_button']='Visi skolotāji';
$string['home_trainers']='Valodu trenneri';
$string['home_trainers_desc1']='Palīdzēs runāt ar pārliecību ';
$string['home_trainers_desc2']='Pilnveidos izrunas nianses un akcentu';
$string['home_trainers_desc3']='Iemācīs sarunāties kā dzimtajā valodā';
$string['home_trainers_button']='Visi trenneri';
$string['startlearning'] = 'Izvēlies valodu un sāc mācīties jau šodien';
$string['home_kristine_meet']='Tavs mācību progress ir garantēts';
$string['home_kristine_hi']='Tavi panākumi ir mūsu prioritāte!';
$string['aboutkristine'] = '';
$string['chooserighttutor'] = '';
$string['motivatedlearner'] = '';
$string['friendlypolicy'] = '';
$string['journeytogether'] = 'Jautājumi?';
$string['bookaconsult'] = 'Pieteikties bezmaksas konsultācijai';
$string['home_kristine_bookacall']='Sazinies ar Kristīni';
$string['home_kristine_li1']='Apsolam ka pie mums Tev būs īsts mācību progress';
$string['home_kristine_li2']='Sadarbojamies tikai ar pārbaudītiem pasniedzējiem';
$string['home_kristine_li3']='Draudzīgā komanda palīdzēs un atbalstīs jebkurā jautājumā';
$string['home_kristine']='Kristīne, Lonet.Academy dibinātāja';
$string['home_kristine_traveler']='Valodu izglītotāja, personīgā snieguma koučs, <br>poliglots un pasaules apceļotāja';
$string['lonetwork'] = 'Sākt mācīties ir tik viegli';
$string['findmatch'] = 'Izvēlies valodu un pasniedzēju';
$string['bookcall'] = 'Rezervē mācību online';
$string['getconnect'] = 'Sāc mācīties';
$string['picklang'] = 'Norādi valodu. Izvēlies pasniedzēju.';
$string['pickdate'] = 'Izvēlies kad un cikos. Piesaki zvanu. ';
$string['meetonline'] = 'Iepazīsti pasniedzēju. Atklāj jaunu pasauli. ';
$string['getexcited'] = '';
$string['make1step'] = '';
$string['transformfuture'] = '';
$string['fortutor'] = 'Valodu pasniedzējiem, koučiem un trenneriem';
$string['whychoose'] = 'Pievienojies';
$string['home_why_desc']='Piedāvājam draudzīgu vidi valodu pasniegšanai. Mūsu misija - izglītot, iedvesmot un palīdzēt cilvēkiem apgūt viņu sapņu valodu.';
$string['home_why_li1']='Nekādas komisijas maksas';
$string['home_why_li2']='Motivēti studenti no visas pasaules';
$string['home_why_li3']='Draudzīgi nosacījumi';
$string['home_why_benefits']='Uzzini vairāk';
$string['home_why_apply']='Pievienojies mums';
$string['studentsays'] = 'Studentu atsauksmes';
$string['home_ebook_title']='Reģistrējies un saņem dāvanā e-grāmatu';
$string['home_ebook_desc']='"Kā iemācīties svešvalodu īsā laikā"';
$string['home_ebook_button']='Saņem e-grāmatu!';