...
$string['site_heading'] = 'Лучшие онлайн репетиторы по скайпу';
...
$string['langcoaches'] = 'С языковым коучем';
$string['langcoaches1'] = 'установи четкую цель';
$string['langcoaches2'] = 'разработай успешную стратегию';
$string['langcoaches3'] = 'убери страхи и ограничения';
$string['viewallcoaches'] = 'Выбери коуча';
$string['langtutors'] = 'С супер репетитором';
$string['langtutors1'] = 'отработай хорошо грамматику';
$string['langtutors2'] = 'расширь словарный запас';
$string['langtutors3'] = 'следуй эффективному плану';
$string['viewalltutors'] = 'Выбери репетитора';
$string['langtrainers'] = 'С тренером-носителем';
$string['langtrainers1'] = 'убери языковой барьер';
$string['langtrainers2'] = 'отработай произношение';
$string['langtrainers3'] = 'заговори как носитель';
$string['viewalltrainers'] = 'Выбери тренера';
$string['startlearning'] = 'Выбери твой любимый язык и начни увлекательный процесс изучения';
$string['meetcreator'] = 'Основатель Lonet.Academy открыта к разговору';
$string['meetcreatorp1'] = 'создатель Lonet Academy • предприниматель • полиглот • коуч по личностному росту • языковой коуч • вдохновляющий преподаватель •';
$string['meetcreatorp2'] = 'коуч малого и среднего бизнеса • кругосветчик';
$string['imkristine'] = 'Привет! Я - Кристина';
$string['bookaconsult'] = 'Бронируй консультацию со мной';
$string['lonetwork'] = 'Учить языки с нами - это легко';
$string['findmatch'] = 'Выбери понравившегося тебе преподавателя';
$string['getexcited'] = 'Выбор в твоих руках!';
$string['bookcall'] = 'Смело бронируй пробный урок';
$string['make1step'] = 'Действуй!';
$string['getconnect'] = 'Знакомься с твоим личным репетитором онлайн!';
$string['transformfuture'] = 'Успех гарантирован!';
$string['chooselang'] = 'Выбери язык';
$string['besttutorselected'] = 'Возьми изучение языка под контроль, научись говорить свободно!';
$string['ourvalues'] = 'Ценности';
$string['history'] = 'История';
$string['ourpartners'] = 'Наши партнеры';
$string['forlearners'] = 'Для учеников';
$string['freeconsult'] = 'Бесплатная консультация';
$string['join'] = 'Зарегистрироваться';
$string['ourblog'] = 'Наш блог';
$string['giftcard'] = 'Подарочные карты';
$string['foreducators'] = 'Для преподавателей';
$string['talktokristine'] = 'Задать вопросы';
$string['educatorsconduct'] = 'Правила для преподавателей';
$string['codeofethics'] = 'Этика преподавателей';
$string['popularlanglesson'] = 'Популярные языки';
$string['language'] = 'язык';
$string['paymethods'] = 'Способы оплаты';
$string['termandcond'] = 'Положения и условия';
$string['privacypolicy'] = 'Политика приватности';