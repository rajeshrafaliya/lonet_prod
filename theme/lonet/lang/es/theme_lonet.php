...
$string['login'] = 'Login';
$string['register'] = 'Regístrate';//Registrarse
$string['createaccount'] = 'Regístrate';//Crear una cuenta
...
$string['menutagline'] = ' Clases particulares de idiomas online';
$string['latestposts'] = 'Latest Blog Posts';
$string['readmore'] = 'Lee más';
$string['readless'] = 'Read less';
$string['findlanguage'] = 'Busca idioma';

$string['contactus'] = 'Contactar con nosotros';
$string['applyforconsultation'] = 'Solicita una consulta gratis';
$string['freeconsultation'] = 'Consulta gratis';
$string['apply'] = 'Solicita';
$string['legaladdress'] = 'Dirección legal';
$string['crn'] = 'CRN';
$string['paymentmethods'] = 'Métodos de pago';
$string['aboutus'] = 'Sobre nosotros';
$string['information'] = 'Información';
$string['howitworks'] = 'Cómo funciona';
$string['aboutmissionvalues'] = 'Misión y valores';
$string['frequentlyaskedquestions'] = 'Preguntas frecuentes';
$string['faq'] = 'FAQ';
$string['corporate'] = 'Corporativo (Asociación)';
$string['giftcards'] = 'Comprar tarjeta de regalo';
$string['languagecamplink'] = 'Reunión de verano';
$string['careers'] = 'How to become a Teacher on LONET';
$string['terms'] = 'Términos y condiciones';
$string['pricavy'] = 'Política de privacidad';
$string['blog'] = 'Blog';
$string['viewallteachers'] = 'Elige tutor/a';
$string['chooselanguage'] = 'ELIGE IDIOMA PARA APRENDER';
$string['whatmemberssay'] = 'What Our Members Say About LONET';
$string['readfulltestimonial'] = 'Read full testimonial';
$string['populartutors'] = 'Tutores de idiomas en línea uno a uno populares en LONET';
$string['onlinetutors'] = 'Tutors Online';
$string['site_heading'] = 'Aprende idiomas con profesores particulares online';

$string['h1_page_howitworks'] = 'How It Works';
$string['meta_title_page_howitworks'] = 'Profesores de idiomas en línea. ¿Cómo funciona Lonet.Academy?';
$string['meta_description_page_howitworks'] = 'Cómo registrarse en Lonet.Academy. Cómo elegir un profesor de idioma en línea y reservar una clase de prueba con los mejores profesores de idiomas online.';
$string['h1_page_aboutmissionvalues'] = 'Misión y valores';
$string['meta_title_page_aboutmissionvalues'] = 'Acerca de Lonet.Academy. Nuestra misión y valores fundamentales.';
$string['meta_description_page_aboutmissionvalues'] = 'Nuestros tutores de idiomas extranjeros crean lecciones individuales para personas de todo el mundo para ayudarles a aprender idiomas de forma rápida y personalizada. ¡Enamórate del aprendizaje de idiomas en Lonet.Academy!';
$string['h1_page_corporate'] = 'Corporativo (Asociación)';
$string['meta_title_page_corporate'] = 'Corporativo (Asociación)';
$string['meta_description_page_corporate'] = 'Corporativo (Asociación)';
$string['h1_page_faq'] = 'Preguntas frecuentes';
$string['meta_title_page_faq'] = 'Preguntas frecuentes';
$string['meta_description_page_faq'] = 'Preguntas frecuentes';
...
$string['h1_page_giftcard'] = 'Ház el mejor regalo - ¡el regalo del saber!';
$string['meta_title_page_giftcard'] = 'Gift Cards For Language Learning Online';
$string['meta_title_page_languagecamp'] = 'Campamento de verano de inglés en España. Cursos de inglés con Lonet.Academy en Barcelona.';
$string['meta_description_page_languagecamp'] = 'Campamento de verano de inglés en España. Cursos de inglés con Lonet.Academy en Barcelona con actividades en equipo y networking.';
...
$string['meta_title_page_teacher_list'] = 'Profesores particulares de idiomas en línea. Reservar una clase de prueba online en Lonet.Academy.';
$string['meta_description_page_teacher_list'] = '¡Elige el mejor profesor de idiomas online y reserva una clase de prueba en línea en Lonet.Academy!';
$string['languages'] = 'Languages';
$string['Refer_a_friend_get'] = 'Refiera a un amigo y obtenga 10 EUR';
$string['share_it_with_friends'] = 'Si le gusta usar Lonet.Academy, compártelo con amigos y colegas para ganar créditos gratis.';
$string['Invite_now'] = 'Invitar ahora';
$string['Profile_Completion'] = 'Finalización del perfil';
$string['Acceptance_Rate'] = 'Nivel de aceptación';
$string['completeprofile'] = 'Completa tu perfil';
$string['downloadebook'] = 'Descarga mi libro electrónico';
$string['ourvalues'] = 'Nuestros valores';
$string['history'] = 'La historia';
$string['ourpartners'] = 'Nuestros socios';
$string['forlearners'] = 'Para alumnos';
$string['freeconsult'] = 'Consulta gratuita';
$string['join'] = 'Registrarse';
$string['ourblog'] = 'Articulos en blog';
$string['giftcard'] = 'Tarjetas de regalo';
$string['foreducators'] = 'Para profesores';
$string['talktokristine'] = 'Hablar con Kristine';
$string['educatorsconduct'] = 'Código de conducta';
$string['codeofethics'] = 'Código de ética';
$string['popularlanglesson'] = 'Idiomas más populares';
$string['language'] = 'Aprender';
$string['paymethods'] = 'Formas de pago';
$string['termandcond'] = 'Términos y condiciones';
