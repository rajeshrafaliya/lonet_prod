...
// Redirect to teachers lists if the teacher is not approved
if($user->profile_field_role == 'Teacher' && !$isadmin && $USER->id != $id && ($user->profile_field_passedinterview == 0 || $user->profile_field_passedtest == 0)){
	$url = $CFG->wwwroot . '/language-teachers';
	?>
	<script>
...
<!-- Breadcrumb -->
<ol class="breadcrumb teacher-breadscrumb" style="padding:0;">
	<li><a href="/">Lonet</a> ></li>
	<li><a href="/language-teachers/"><?= get_string('teacher_breadcrumb_all_teachers', 'local_lonet') ?></a> ></li>
	<li class="active"><?= $userfullname ?></li>        
</ol>
