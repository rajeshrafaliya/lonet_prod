...
<div class="top-section <?= (isloggedin() && !isguestuser() ? 'logged-in' : '') ?>">
	 <div class="container-fluid">
			<div class="row-fluid">
				...
				?>
				<!--div class="col-sm-5 text-center langmenuu" <?= $style ?>>
...
<div class="custom-section">
	<div class="container-fluid">
		...
		<header role="banner" class="navbar <?php echo $html->navbarclass ?> pull-right container-search">
			...
			<span class="badge badge-teacher pull-left hidden" style="text-transform: uppercase;position: absolute;margin-left: -25px;"><?= get_string('badge_new','local_lonet') ?></span>
			<a class="btn btn-success btn-lonet btn-sm pull-left hidden" style="margin-top: 13px;margin-bottom: 13px;text-transform: initial;" href="<?= $grouplessonlink ?>" target="_blank" rel="noopener noreferrer"><?= get_string('grouplessons','local_lonet') ?></a>	
