...
if ($mform->is_cancelled()) {
    ...
    notice($strpasswordchanged, new moodle_url($CFG->wwwroot.'/user/'.$USER->id, array('return'=>1)));
...
echo '<h5 class="forgettitle" style="color: #374151;text-align: center;font-size: 32px;font-weight: 700;line-height: 40px;letter-spacing: -0.64px;margin-bottom:64px;">'.get_string('changepassword').'</h5>';
echo '<div class="changepasswordform">';
$mform->display();
echo '</div>';
