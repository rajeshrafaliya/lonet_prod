...
class login_forgot_password_form extends moodleform {
    ...
    function definition() {
        ...
        $mform->addElement('text', 'username', get_string('searchbyusername'),array('placeholder' => 'Username','id'=>'username'));
        ...
        $mform->addElement('text', 'email', get_string('searchbyemail'),array('placeholder' => 'Email address','id'=>'email'));
