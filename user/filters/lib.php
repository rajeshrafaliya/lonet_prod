...
class user_filtering {
    ...
    public function __construct($fieldnames = null, $baseurl = null, $extraparams = null) {
        ...
        if (empty($fieldnames)) {
            $fieldnames = array('realname' => 0, 'lastname' => 1, 'firstname' => 1, 'username' => 1, 'email' => 1, 'city' => 1, 'country' => 1,
                                ...
                                'nevermodified' => 1, 'timecreated' => 1, 'auth' => 1, 'mnethostid' => 1, 'idnumber' => 1);
        }
    ...
    public function get_field($fieldname, $advanced) {
        ...
        switch ($fieldname) {
			...
			case 'timecreated': return new user_filter_date('timecreated', 'Registration date', $advanced, 'timecreated'); //Added by Nitesh
